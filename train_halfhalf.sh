...
python -u train_model.py ./Data/train_ann_encoded.csv ./Data/val_ann_encoded.csv ../../Data 100 ./model/model_gcn_baseline_tuned ./Data/baseline_glove_word2vec.pkl ./Data/baseline_left_labels.pkl
#sleep 1
exit
